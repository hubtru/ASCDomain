...
class PLModule(pl.LightningModule):
    def __init__(self, config):
        ...
        # the mobilenet model
        self.model = get_cp_resnet(base_channels=config.base_channels)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mixstyle_p', type=float, default=0.8)  # frequency mixstyle #0.8 for next
    ...
    parser.add_argument('--dir_prob', type=float, default=0.4)  # device augmentation #0.4 next
