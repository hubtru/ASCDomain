...
from datasets.dcase24_dir_logits import get_training_set, get_test_set, get_eval_set
from helpers.init import worker_init_fn
from helpers.utils import mixstyle
from helpers import nessi
from models.convmixer_adv import get_model
...
class PLModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # teacher loss: Temperature adjusted probabilities of teacher and student
        ...
        # distillation loss + discriminator loss
        loss = loss + self.config.disc_lambda * disc_loss_mean
        ...
        results = {
                ...
                "disc_loss": self.config.disc_lambda * disc_loss_mean,
                "n_correct": n_correct,
    ...
    def on_train_epoch_end(self):
        ...
        avg_disc_loss = outputs['disc_loss'].mean()

        acc = sum(outputs['n_correct']) * 1.0 / sum(outputs['n_pred'])

        logs = {'acc': acc, 'loss': avg_loss, 'label_loss': avg_lables_loss, 'kd_loss': avg_kd_loss, 'disc_loss': avg_disc_loss}
...
def evaluate(config):
    ...
    import pandas as pd
    import torch.nn.functional as F
    from datasets.dcase24_dir_logits import dataset_config
...
if __name__ == '__main__':
    ...
    parser.add_argument('--disc_lambda', type=float, default=0.025)
